...
| [Cómo mostrar PDFs en Oracle APEX usando `<object>` e `<iframe>`](https://juanl.hashnode.dev/como-mostrar-pdfs-en-oracle-apex-usando-object-e-iframes) | [preview-pdfs](/preview-pdfs) | Ejemplo práctico para previsualizar PDFs y otros archivos en Oracle APEX. | ✅ |
